...
const { ReplyEngine } = require('./reply/reply-engine');
const { NetworkMonitor } = require('./traffic/network-monitor');
const { PddApiClient } = require('./pdd-api');
const { MailApiClient } = require('./business-api/mail-api');
const { InvoiceApiClient } = require('./business-api/invoice-api');
const { TicketApiClient } = require('./business-api/ticket-api');
const { ViolationApiClient } = require('./business-api/violation-api');
const { DeductionApiClient } = require('./business-api/deduction-api');
const { createSettingsWindow } = require('./windows/settings-window');
const { createLicenseWindow, getLicenseWindow, destroyLicenseWindow } = require('./windows/license-window');
const { createDebugWindow, sendToDebug } = require('./windows/debug-window');
const { ShopManager } = require('./shop-manager');
const { TokenFileStore } = require('./token-file-store');
const { SYSTEM_PHRASES, DEFAULT_SCENES, PHRASE_CATEGORIES, DEFAULT_AI_INTENTS } = require('./reply/system-phrases');
const { AIIntentEngine } = require('./reply/ai-intent');
const {
  appendApiTrafficLog,
...
const { registerApiIpc } = require('./ipc/register-api-ipc');
const { registerReplyIpc } = require('./ipc/register-reply-ipc');
const { registerDebugIpc } = require('./ipc/register-debug-ipc');
const { registerEmbeddedViewIpc } = require('./ipc/register-embedded-view-ipc');
const { registerMailDetailWindowIpc } = require('./ipc/register-mail-detail-window-ipc');
const { registerAfterSaleDetailWindowIpc } = require('./ipc/register-aftersale-detail-window-ipc');
const { registerInvoiceOrderDetailWindowIpc } = require('./ipc/register-invoice-order-detail-window-ipc');
const { registerTicketTodoDetailWindowIpc } = require('./ipc/register-ticket-todo-detail-window-ipc');
const { registerLicenseIpc } = require('./ipc/register-license-ipc');
const { isLicenseValid } = require('./license/license-store');
const { registerViolationInfoWindowIpc } = require('./ipc/register-violation-info-window-ipc');
const { registerSystemNotificationIpc, showDesktopNotification } = require('./ipc/register-system-notification-ipc');
const { appendWindowCloseDebugLog, getWindowCloseDebugLogPath } = require('./windows/window-close-debug-log');
