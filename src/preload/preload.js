...
contextBridge.exposeInMainWorld('pddApi', {
  ...
  aftersaleRejectRefundPreCheck: (params) => ipcRenderer.invoke('aftersale-reject-refund-precheck', params),
  aftersaleRejectRefundGetFormInfo: (params) => ipcRenderer.invoke('aftersale-reject-refund-get-form-info', params),
  aftersaleRejectRefundGetNegotiateInfo: (params) => ipcRenderer.invoke('aftersale-reject-refund-get-negotiate-info', params),
  aftersaleRejectRefundSubmit: (params) => ipcRenderer.invoke('aftersale-reject-refund-submit', params),
  aftersaleRejectRefundGetReasons: (params) => ipcRenderer.invoke('aftersale-reject-refund-get-reasons', params),
  aftersaleRejectRefundValidate: (params) => ipcRenderer.invoke('aftersale-reject-refund-validate', params),
  aftersaleMerchantRefuse: (params) => ipcRenderer.invoke('aftersale-merchant-refuse', params),
